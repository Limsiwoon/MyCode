...
export const data = [
  ...
  }, // data 배열 의 두번째 원소 : 객체2 (생선 타코)
  {
    "name": "매운 떡볶이",
    "ingredients": [
      { "name": "가래떡", "amount": 500, "measurement": "그램" },
      { "name": "육수", "amount": 2, "measurement": "컵" },
      { "name": "대파", "amount": 0.5, "measurement": "단" },
      { "name": "고추장", "amount": 3, "measurement": "숫가락" },
      { "name": "양파", "amount": 0.5, "measurement": "개" },
      { "name": "치즈", "amount": 1, "measurement": "봉지" }
    ],
    "steps": [
      "팬을 예열한다.",
      "육수를 붓고 고추장을 던다.",
